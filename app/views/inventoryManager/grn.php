...
<body>
    ...
    <div class= "rcontainer">
        <h2 class="rh2" >Generate Reports</h2>

        <div class="input-group">
            <label class="rlabel" for="reportType">Report Type:</label>
            <select class="rselect" id="reportType">
                <option value="inventory">Inventory Report</option>
                <option value="customer">Least flowing inventory Report</option>
            </select>
        </div>

        <div id="filters" class="input-group">
            <label class="rlabel" for="filterCriteria">Filter Criteria:</label>
            <input class="rinput" type="text" id="filterCriteria" placeholder="filter..">
        </div>

        <div class="buttons">
            <button class = "rbutton" id="viewReport">View Report</button>
            <button class = "rbutton" id="exportCSV">Export CSV</button>
            <button class = "rbutton" id="exportExcel">Export Excel</button>
            <button class = "rbutton" id="exportPDF">Export PDF</button>
        </div>
